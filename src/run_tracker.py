...
def main() -> int:
    ...
    # 相机照常采集、照常进视频，只是不参与定位。当前为空：唯一用过它的 DB0260405 已解禁。
    # 沿革：2026-08-15 因 405 外参偏 ~7px（带它的相机对射线交不到 12~19mm，其余 0.4~4.1mm，
    # 18° 小视差下放大成 15~20cm 深度误差）把 405 从球三角化与车定位两条路径一起摘掉；
    # 2026-08-17 21:17 WickyK 的 392d035 重标了 405 外参，留一重投影 11.46→5.18px，
    # 已不再是离群台（414 5.60、378 3.73、373 3.32），2026-08-18 放回两条路径。
